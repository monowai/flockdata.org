 ...
 */
public interface EntityTagOutRepo extends GraphRepository<EntityTagOutRlx> {
    @Query (elementClass = EntityTagOutRlx.class, value = "match (e:Entity)-[r]->(:Tag) where id(e) = {0} return r")
