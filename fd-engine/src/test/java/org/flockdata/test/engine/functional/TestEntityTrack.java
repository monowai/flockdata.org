...
public class TestEntityTrack extends EngineBase {
    ...
    public void trackByCallerRef_NoContentNoUser() throws Exception {
        ...
        FortressInputBean fortress = new FortressInputBean("trackByCallerRef_NoContentNoUser", true);
    ...
    public void trackByCallerRef_NoContent_WithFortressUser() throws Exception {
        ...
        EntityInputBean inputBean = new EntityInputBean(fortressInput.getName(), "wally", "TestTrack", new DateTime(), "ABC123");
    ...
    public void track_WithSingleLog() throws Exception {
        ...
        fortressService.registerFortress(su.getCompany(), fib);
...
//        assertNotNull(lastLog.getAuditChange().getLogInputBean());
    ...
    public void date_FortressDateFields() throws Exception {
        ...
        assertEquals(IndexHelper.PREFIX + su.getCompany().getCode() + "." + fo.getCode(), entity.getFortress().getIndexName());
    ...
    public void clientInDifferentTZ() throws Exception {
        ...
        assertEquals("Why is this failing", IndexHelper.PREFIX + su.getCompany().getCode() + "." + fo.getCode(), entity.getFortress().getIndexName());
