...
fdView.controller('ViewEntityCtrl', ['$scope', '$stateParams', '$uibModal', 'configuration', 'EntityService', 
  function ($scope, $stateParams, $uibModal, configuration, EntityService) {
