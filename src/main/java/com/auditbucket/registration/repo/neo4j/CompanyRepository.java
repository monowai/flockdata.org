...
public interface CompanyRepository extends GraphRepository<Company> {
	...
	@Query(elementClass = CompanyUser.class, value = "start company=node:companyName(name={0}) match company<-[:companyUser]-companyUsers return companyUsers")
    ...
    @Query(elementClass = CompanyUser.class, value = "start company=node({0}) match company-[r:companyUser]-companyUser where companyUser.name ={1} return companyUser")
