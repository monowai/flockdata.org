...
public class PropertyConversion {
    ...
    public static DefinedProperty convertProperty(int propertyKeyId, Object value) {
    ...
    public static DefinedProperty arrayProperty(int propertyKeyId, Object[] value) {
        if (value instanceof String[]) {
    ...
    public static String toJsonColumn(String column, Object value) {
        if (value instanceof String) {
